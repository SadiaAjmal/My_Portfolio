...
const Process = () => {
  return (
    <div className=" process flex lg:flex-row flex-col items-center justify-between pt-56 md:pt-40 px-3 py-10 lg:px-34 xl:px-40  md:px-20 bg-process-bg  space-y-5">
