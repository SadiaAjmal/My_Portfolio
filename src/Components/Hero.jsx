...
const Hero = () => {
  return (
    <div className="hero justify-center flex md:h-[110vh] lg:h-[150vh]  bg-custom-bg px-3 md:py-5 lg:px-40 md:px-20 ">
      ...
      <div className="hero-about lg:px-20 absolute lg:bottom-[-60%] md:bottom-[-20%] ">
        <About />
      </div>
    </div>
  );
