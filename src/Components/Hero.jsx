...
const Hero = () => {
  return (
      ...
      <div className="hero lg:px-34 flex xl:px-40 justify-center lg:h-[150vh] md:h-[115vh] h-[180vh] bg-custom-bg px-3 md:py-5  md:px-20 ">
      ...
      <div className=" absolute md:bottom-[-25%] bottom-[-100%] lg:bottom-[-65%]">
        <About />
      </div>
      </div>
