...
const About = () => {
  return (
      ...
      <div className="lg:px-20 mx-3 lg:mx-20  md:mx-10 about bg-white box-border  md:p-16 px-3 py-8 pb-16 rounded-lg mt-10 shadow-lg flex lg:flex-row flex-col-reverse items-center justify-between">
        <div className=" order-2 basis-[58%] lg:space-y-5 space-y-3">
          ...
          <p>
            ...
            Proficient in HTML, CSS, JavaScript and React Js, I'm passionate
            about crafting user-friendly interfaces. Currently exploring latest
            trends and best practices through online courses and personal
            projects.
          </p>
          <p>
